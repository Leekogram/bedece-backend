                                                        ...
                                                        <tr style="border-collapse:collapse;">
                                                            <td width="600" valign="top" align="center" style="padding:0;Margin:0;">
                                                                <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-radius:4px;background-color:#FFFFFF;" width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff" role="presentation">
                                                                    ...
                                                                    <tr style="border-collapse:collapse;">
                                                                        <td align="center" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:35px;padding-bottom:35px;"> <h3 class="es-button-border" style="display:inline-block;border-radius:8px;width:auto;">  <a href="https://reset313.herokuapp.com/reg/activate-account/${this.id} ">Click on this link to activate your account</a></h3></td>
                                                                    ...
                                                                    <tr style="border-collapse:collapse;">
                                                                        <td class="es-m-txt-l" align="left" style="padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px;"> <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:Montserrat, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;">
                                                                            You will not be able to use this acoount till it is activated. </br>If you have any questions, just reply to this
